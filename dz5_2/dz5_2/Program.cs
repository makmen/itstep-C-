...
namespace dz5_2
{
    ...
    struct Client
    {
        ...
        public ClientType enumClientType;
        ...
        public Client(uint clientId_, string clientFio_, string clientAdress_, string clientPhone_, uint orderCount_, double orderSumma_)
        {
            ...
            enumClientType = ClientType.Important;
        }
    ...
    struct Article
    {
        ...
        public ArticleType enumArticleType;
    ...
    enum ArticleType { Chemical, Technics, Dinnerware };

    enum ClientType { NotImportant, Important, Major };

    enum PayType { Cash, CreditCard };
}
